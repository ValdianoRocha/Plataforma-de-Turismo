...
import { createPlace, crieteAdm, crieteUser, deletePlaces, filterPlaces, getAllPlaces, logim, updatePlaces } from '../controller/userController.js'
...
// router.post('/auth/login', logim)// login
