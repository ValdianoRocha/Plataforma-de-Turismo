...
import {
    createPlace, crieteAdm, crieteUser, deletePlaces, filterPlaces, getAllPlaces,
    loginController, updatePlaces
...
router.post('/places', validate(createPlaceSchema), authenticate, permissionAdmin, createPlace)//Criar Locais de turismo (OK)
...
router.put('/places/:id', validate(updatePlaceSchema), authenticate, permissionAdmin, updatePlaces)//Atualiza os dados de um local existente. (ok)
